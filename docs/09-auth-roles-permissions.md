> **ARŞİV — UYGULANMADI.** Bu doküman Clerk auth, roller ve izinler tarifini içerir ve `ADR-008` ile
> kapsam dışına alınmıştır. Kodda karşılığı **yoktur**. Tarihsel bağlam ve
> olası Faz 2 yeniden değerlendirmesi için saklanır; buradan hiçbir
> implementasyon kararı türetilmez.
>
> Arşive alınma doğrulaması: 2026-08-19.
