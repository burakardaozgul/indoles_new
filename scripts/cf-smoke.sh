...
echo "1) Rotalar"
for path in /tr /en /tr/hizmetler/cro /tr/vakalar /tr/yazilar /tr/araclar/geo-gorunurluk-denetleyicisi /en/tools/geo-visibility-checker /tr/araclar/diagnoo /en/tools/diagnoo; do
  c=$(code "$BASE$path")
