 ...
 *
 * Satır içi link çözücü (`renderInline`, markdown-lite `[metin](/yol)`)
 * `@/components/marketing/inline-markdown`e taşındı (Faz 2 Görev 2) —
 * makale→araç köprü paragrafları (`ArticleToolBridges`) aynı çözücüyü
 * paylaşır, davranış iki yüzeyde de birebir aynı kalır.
 */
      ...
      <article>
        <div className="ds-container py-16 md:py-24">
          <div className="mx-auto max-w-170">
            ...
            {/* Makale → araç köprüsü (Faz 2 Görev 2, üçgenin araç→makale
                ayağı) — yayın kapılı: `ArticleToolBridges` yalnız yayınlanmış
                aracı olan bir köprü bulursa basar (ADR-032 ile aynı bayrak). */}
            <ArticleToolBridges articleSlugTr={a.slug.tr} locale={loc} />
