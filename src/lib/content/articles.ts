  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        type: "p",
        text: {
          tr: "Bu işi kendi ekibinizle mi yürüteceğinize yoksa dışarıdan destek mi alacağınıza karar veriyorsanız, [bir CRO ortağını değerlendirirken nelere bakılacağını](/yazilar/cro-ajansi-nasil-secilir) ayrı bir yazıda topladık. İşi bir ekibe emanet etmeyi düşünüyorsanız, [dönüşüm oranı optimizasyonu hizmetimizin](/hizmetler/cro) hangi adımlarla yürüdüğü hizmet sayfasında anlatılıyor.",
          en: "If you are deciding whether to run this with your own team or bring in outside support, we have gathered [what to look at when evaluating a CRO partner](/yazilar/cro-ajansi-nasil-secilir) in a separate article. If you are considering handing the work to a team, the service page sets out how [our conversion rate optimisation service](/hizmetler/cro) runs step by step.",
        },
      },
    ],
    faq: [
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        type: "p",
        text: {
          tr: "Tez tek cümle: mağazanızın asıl sorunu trafik değil, ideal hâline olan ölçülmemiş uzaklıktır. Bugün yapabileceğiniz somut test şu — ana sayfanızı, en kalabalık iki kategorinizi, üç ürün sayfanızı ve ödeme adımınızı mobil bir cihazda sırayla açın, her ekranda tek bir soruyu sorun (\"bir sonraki adım ne\") ve cevabın kaç saniyede geldiğini not edin. Yedi sayfanın dördünde cevap gecikiyorsa, GAP analizini bir denetim olarak kurmanın vakti gelmiştir. [GYMWOLVES vakasında](/vakalar/gymwolves-12-kat-satis) veri akışı onarılıp huni yeniden kurulduktan sonra üç ayda satış 12 katına, ürün sayfası iyileştirmelerinin ardından oturum süresi 3 katına çıktı; sıra doğru kurulduğunda kapanan fark bu büyüklükte olabiliyor. Denetimi kendi ekibinizle kuramıyorsanız, [e-ticaret danışmanlığı hizmetimiz](/hizmetler/e-ticaret) aynı yedi sayfayı aynı yöntemle tarar ve kapatma planını sizinle birlikte kurar.",
          en: "The thesis in one sentence: your store's real problem is not traffic but the unmeasured distance to its ideal version. The concrete test you can run today — open your home page, your two busiest categories, three product pages and your checkout step on a mobile device in that order, ask one question on each screen (\"what is the next step\") and note how many seconds the answer takes. If the answer is late on four of the seven pages, it is time to set the GAP analysis up as an audit. In [the GYMWOLVES case](/vakalar/gymwolves-12-kat-satis), once the data flow was repaired and the funnel rebuilt, sales rose 12× in three months and session duration tripled after the product page improvements; when the order is right, the gap that closes can be that large. If you cannot set the audit up in-house, [our e-commerce consultancy service](/hizmetler/e-ticaret) scans the same seven pages with the same method and builds the closing plan with you.",
        },
      },
    ],
    faq: [
